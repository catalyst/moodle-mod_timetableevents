        ...
        if ($acadyears) {
            ...
            if ($acadyears && count($groups->groups) > 0) {
                ...
                $mform->addElement(
                    'button',
                    'groupoverrides',
                    get_string('coursesetting:groupoverride:add', 'timetableevents'),
                    null,
            ...
            $mform->addElement(
                'select',
                'firstsection',
                get_string('coursesetting:firstsection', 'timetableevents'),
                $sectionoptions
            );
            ...
            $mform->addElement(
                'select',
                'teachinginverval',
                get_string('coursesetting:teachinginverval', 'timetableevents'),
                $intervaloptions
            );
            ...
            $mform->addElement(
                'autocomplete',
                'readingweek',
                get_string('coursesetting:readingweeks', 'timetableevents'),
                $sectionoptions,
                $options
            );
            ...
            $mform->addElement(
                'autocomplete',
                'excluded',
                get_string('coursesetting:excludedsections', 'timetableevents'),
                $sectionoptions,
                $options
            );
        ...
        if ($year = $acadyearel->getValue()) {
            ...
            if ($terms) {
                ...
                foreach ($terms as $term) {
                    $termoptions[$term->termid] = get_string(
                        'coursesetting:term:options',
                        'timetableevents',
                        [
                            'termno' => $term->termno,
                ...
                $termel = $mform->createElement(
                    'select',
                    'term',
                    get_string('coursesetting:term', 'timetableevents'),
                    $termoptions
                );
